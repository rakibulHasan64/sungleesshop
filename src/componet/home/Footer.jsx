...
function Footer() {
   return (
      <>
         <footer className="bg-[#001d6d] pt-14  px-8 font-[sans-serif] tracking-wide">
            <div className="max-w-screen-xl mx-auto">
               <div className="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-3 gap-12">
                  <div>
                     <h3 className="text-4xl font-bold text-white">shop</h3>
                     <ul className="mt-10 lg:space-y-6 max-lg:flex max-lg:space-x-4">
                        <li className="bg-gray-200 hover:bg-white h-8 w-8 rounded-full flex items-center justify-center shrink-0">
                           <a href="#">
                  ...
                  <div>
                     <h4 className="text-white font-semibold text-lg">Professional Web Design</h4>
                     <p className="text-sm mt-6 text-gray-300">High level experience in web design and development knowledge, producing
                        quality work.</p>

                     <ul className="mt-10 space-y-6">
                        <li className="flex items-center">
                           <div className="bg-gray-200 h-8 w-8 rounded-full flex items-center justify-center shrink-0">
                           ...
                           <a href="#" className="text-gray-300 text-sm ml-4">
                  ...
                  <div className="bg-gray-100 p-6 rounded-md max-lg:col-span-full sm:max-w-md">
                     <h4 className="text-black font-semibold text-lg">Contact Us</h4>
                     <p className="text-sm text-gray-500 mt-4">We usually respond before 24 hours.</p>

                     <form className="mt-10 space-y-3">
                        <input type='text' placeholder='Name' className="w-full rounded-md h-10 px-4 bg-white text-sm outline-none" />
                        <input type='text' placeholder='Email' className="w-full rounded-md h-10 px-4 bg-white text-sm outline-none" />
                        <textarea placeholder='Message' rows="6"
                           className="w-full rounded-md px-4 bg-white text-sm pt-3 min-h-[100px] outline-none"></textarea>
                     </form>

                     <button type='button' className="text-white bg-[#001d6d] hover:bg-[#001d5d] rounded-md text-sm px-4 h-10 block mt-6 w-full">Submit</button>
                  </div>
               </div>
               ...
               <div className="lg:flex lg:item-center">
                  <ul className="flex flex-wrap gap-4">
                     <li>
                        <a href='#' className='text-gray-300 hover:text-white text-sm hover:underline'>Terms of Service</a>
                     </li>
                     <li>
                        <a href='#' className='text-gray-300 hover:text-white text-sm hover:underline'>Privacy Policy</a>
                     </li>
                     <li>
                        <a href='#' className='text-gray-300 hover:text-white text-sm hover:underline'>Security</a>
                     </li>
                  </ul>

                  <p className='text-sm text-gray-300 ml-auto max-lg:mt-6'>© ReadymadeUI. All rights reserved.</p>
               </div>
            </div>
         </footer>
